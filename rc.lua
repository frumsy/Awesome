...
beautiful.init("/home/lpcb/.config/awesome/theme.lua")
...
globalkeys = gears.table.join( 
    ...
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo -5%")   end),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo +5%")   end),
    awful.key({ }, "XF86AudioMute",        function () awful.util.spawn("pactl set-sink-mute alsa_output.pci-0000_00_1b.0.analog-stereo toggle")   end),
